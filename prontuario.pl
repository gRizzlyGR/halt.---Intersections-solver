...
%transita(veicolo(marrone), sinistra, braccio(nord)).
%transita(veicolo(camion), destra, braccio(sud)).
%transita(veicolo(giallo), destra, braccio(sud_ovest)).
...
%transita(veicolo(blu2), sinistra, braccio(sud)).
...
%proviene(veicolo(verde), braccio(nord)).
%proviene(veicolo(giallo), braccio(sud)).
%proviene(veicolo(camion_pompieri), braccio(est)).
%proviene(veicolo(blu), braccio(nord)).

%transita(veicolo(camion_pompieri), dritto, braccio(ovest)).
