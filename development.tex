...
%		\adjustbox{raise=-3.5cm}{\includegraphics[width=.4\textwidth]{images/uturn}} & Il veicolo \textbf{B} deve dare precedenza frontale al veicolo \textbf{P}. Se due veicoli vanno nello stesso braccio, uno svoltando a destra e l'altro a sinistra, quello che va a sinistra deve dare la precedenza a quello che va a destra. \\
%		
