...
\vspace{1mm} \\
\vspace{1mm}
\indent \framebox{\textit{Il veicolo nero proviene dal braccio ovest}} \\
\vspace{1mm}
che diventa \\
\vspace{1mm}
\indent \framebox{\texttt{proviene(veicolo(nero), braccio(ovest))}} \\
\vspace{1mm}
\noindent La regex utilizzata è: \\
\vspace{1mm}
\indent \framebox{\texttt{.*veicolo\textbackslash s+(.*)\textbackslash s+proviene.*braccio\textbackslash s+(.*)}} \\ \noindent che valida le stringhe che contengono ``veicolo", ``proviene" e ``braccio", ignorando gli spazi e gli altri caratteri.
...
\vspace{1mm} \\
\vspace{1mm}
\indent \framebox{\textit{Il veicolo nero transita nel braccio nord, svoltando a sinistra}} \\
che diventa \\
\vspace{1mm}
\indent \framebox{\texttt{transita(veicolo(nero), sinistra, braccio(nord))}} \\
\vspace{1mm}
...
\vspace{1mm}\\
\vspace{1mm}
\indent \framebox{\textit{Nel braccio est si trova il segnale dare\_precedenza}} \\
oppure \\
\vspace{1mm}
\indent \framebox{\textit{Nel braccio est c'è il segnale dare\_precedenza}} \\
\vspace{1mm}
che diventa \\
\vspace{1mm}
\indent \framebox{\texttt{si\_trova(segnale(dare\_precedenza), braccio(est))}} \\
\vspace{1mm}
\noindent La regex utilizzata è: \\
\vspace{1mm}
\indent \framebox{\texttt{.*braccio\textbackslash s+(.*)\textbackslash s+c.*segnale\textbackslash s+(.*)}} \\ \noindent che valida le stringhe che contengono ``braccio" e "segnale", ignorando gli spazi e gli altri caratteri.
